import { WebViewBase, knownFolders, traceEnabled, traceWrite, traceCategories } from "./customwebview.common";

export * from "./customwebview.common";

interface WebViewClient {
    new (owner: CustomWebView): android.webkit.WebViewClient;
}
...
function initializeWebViewClient(): void {
    ...
    class WebViewClientImpl extends android.webkit.WebViewClient {
        ...
        public shouldOverrideUrlLoading(view: android.webkit.WebView, request) {
            ...
            owner._onUrlLoading(url, undefined);
            return true;
        }
...
export class CustomWebView extends WebViewBase {
