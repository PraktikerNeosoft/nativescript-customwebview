import { WebViewBase, knownFolders, traceWrite, traceEnabled, traceCategories, NavigationType } from "./customwebview.common";
...
class WKNavigationDelegateImpl extends NSObject
    ...
    public static initWithOwner(owner: WeakRef<CustomWebView>): WKNavigationDelegateImpl {
